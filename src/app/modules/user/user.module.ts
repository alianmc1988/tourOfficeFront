...
import { CalendarioComponent } from './session/calendario/calendario.component';
...
@NgModule({
  ...
  SideMenuComponent, 
  FooterComponent, 
  SessionNavbarComponent, SlideMenuDirective, SessionMainDisplayComponent, HouseBoockingComponent, CalendarioComponent],
  imports: [
    CommonModule,
    UserRoutingModule
  ],
